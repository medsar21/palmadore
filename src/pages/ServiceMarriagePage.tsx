...
import { ArrowLeft, Users, Calendar, Phone, MapPin, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-secondary/20 to-background">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Créez des tables de mariage exceptionnelles avec nos créations chocolatées artisanales, 
              parfaites pour impressionner vos invités et sublimer votre grand jour.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto">
          <div className="relative h-96 md:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
            <img 
              src={cImage} 
              alt="Table de Mariage Palmador"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
            <div className="absolute bottom-6 left-6 text-white">
              <h2 className="text-2xl md:text-3xl font-serif font-bold mb-2">
                Votre Table de Mariage Sur Mesure
              </h2>
              <p className="text-white/90">
                Une œuvre d'art gourmande pour votre réception
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-chocolate mb-6">
              À Propos de Nos Tables de Mariage
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Le mariage est le jour le plus important de votre vie. Nos tables chocolatées sont conçues pour 
              sublimer votre réception et offrir à vos invités une expérience gustative inoubliable. Chaque table 
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-chocolate mb-6">
            Prêt à Créer Votre Table de Mariage ?
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            Contactez-nous dès maintenant pour discuter de votre projet et créer la table de mariage de vos rêves.
          </p>
